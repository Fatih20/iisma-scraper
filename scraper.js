...
const fs = require("fs");
const { YEARS, INTAKE_ATTRIBUTE, REGIONS } = require("./constants");
...
const scrape = pageSupplier(async (page) => {
...
const scrape2 = pageSupplier(async (page) => {
